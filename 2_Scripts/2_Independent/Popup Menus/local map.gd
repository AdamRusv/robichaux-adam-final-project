...
func _change_layout():
	...
	if temporaryLocalSettings.mapLayout == LocalGameSettings.MapLayout.custom:
...
func _update():
	...
	if gameSelectionManager.currentLocalGameSettings.mapLayout == LocalGameSettings.MapLayout.custom:
		holesParent.visible = false
		editButtonParent.visible = true
